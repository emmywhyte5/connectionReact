        ...
        function Book() {
            ...
            let handleSubmit = (event) => {
                ...
                const response=async () => {
                    try {
                        const res = await ('https://node-assign.onrender.com/book/', {
                            method: 'GET',
                            headers: {
            ...
            <div className="h-screen flex items-center justify-center bg-black text-white flex-col">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col w-80 mt-4 space-y-4">
                    ...
                    <label className="flex flex-col">
                        ...
                        <input onChange={handleChange} type="text" name="published_date" className="mt-1 p-2 bg-gray-800 border border-gray-700 rounded" />
                    </label>
        
                    <label className="flex flex-col">
                        <span className="text-lg">author_id:</span>
                        <input onChange={handleChange} type="text" name="author_id" className="mt-1 p-2 bg-gray-800 border border-gray-700 rounded" />
                    </label>
                    <button type="submit" className="mt-4 p-2 bg-blue-500 rounded">Book</button>
